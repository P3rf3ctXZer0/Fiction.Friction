...
Last README file update: Sun Jul 23 02:10:45 CDT 2023
...
command.back
command.backpack
command.backpack.extension
command.backpack.extension.player
command.backpack.extension.player.all
command.backpack.extension.player.all.state
command.backpack.extension.player.extension
command.backpack.extension.player.extension.state
...
command.home
command.home.name
command.hungerstrike
command.hungerstrike.add
command.hungerstrike.add.targets
command.hungerstrike.list
command.hungerstrike.mode
command.hungerstrike.remove
command.hungerstrike.remove.targets
command.hungerstrike.setmode
command.hungerstrike.setmode.all
command.hungerstrike.setmode.list
command.hungerstrike.setmode.none
